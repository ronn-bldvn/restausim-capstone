<div>
    ...
    <form wire:submit.prevent="save" enctype="multipart/form-data" class="">
            ...
            <div class=" p-5 bg-white border border-gray-200 rounded-lg shadow-sm md:flex-row md:max-full dark:border-gray-700 dark:bg-gray-800 mb-5">
                ...
                <div class="mb-6">
                    <button type="button"
                        class="items-center px-4 py-2.5 w-full sm:w-auto bg-[#69EACA] text-black font-medium rounded-lg text-sm transition-all duration-200 shadow-sm hover:shadow-md"
