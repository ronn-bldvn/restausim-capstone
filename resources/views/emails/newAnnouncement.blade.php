                    ...
                    <td style="padding:20px;">
                        ...
                        <div class="activity-card" style="background-color:#FDFDFD; border:1px solid #E0E0E0; border-radius:6px;">
                            <div style="padding:24px;">
                                <strong class="title">Announcement!</strong>
                                <div class="description">{!! nl2br(e($announcementContent->content)) !!}</div>
                                <div class="posted-info">
                                    Posted on {{ \Carbon\Carbon::parse($announcementContent->created_at)->timezone('Asia/Manila')->format('M j, Y \a\t g:i A') }} by <span class="instructor">{{ $faculty->name ?? 'Instructor' }}</span>
                                </div>
                            </div>
                        </div>
