...
<p>You have been invited to join the class: <strong>{{ $section->section_name }}</strong></p>
...
<p>This link will expire on {{ $invite->expires_at }}.</p> --}}
                ...
                <tr>
                    <td style="padding:20px;">
                        ...
                        <div style="text-align:center; margin-bottom:24px;">
                            <span class="badge">Section Invitation</span>
                        ...
                        <div class="activity-card" style="background-color:#FDFDFD; border:1px solid #E0E0E0; border-radius:6px;">
                            <div style="padding:24px;">
                                <strong class="title">{{ $faculty->name ?? 'Instructor' }} invited you to join this section</strong>
                                <div class="description">
                                    <span>
                                        You've been invited to be part of this class section where all activities,
                                            announcements, and course materials will be shared. Joining will allow you to
                                            stay updated and participate in all upcoming tasks and discussions.
                                            You can join by copying this invitation Code

                                            Invitation Code: {{ $section->share_code }}
                                ...
                                <div style="margin-top:24px; text-align:center;">
                                    <a href="{{ route('invite.accept', $invite->token) }}"
                                    style="display:inline-block; background-color:#0D0D54; color:#ffffff; font-size:1rem; padding:14px 28px; border-radius:8px; text-decoration:none;"
                                    class="activity-button">Click Here to Join the Section</a>
                                </div>

                                <div class="posted-info">
                                    Note that this link will expire at {{ $invite->expires_at }}.
                                </div>
                            </div>
                        </div>
