    ...
    <div class="flex-1 overflow-y-auto p-5 bg-white">
        ...
        <div class="flex justify-between items-center px-5 mb-6">
            ...
            <div class="flex gap-3">
                ...
                <x-button id="openCreateSection" class="flex items-center gap-2 cursor-not-allowed">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 px-5">
            @foreach ($sections as $section)
                <div
                    ...
                    <a
                        href="{{ route('faculty.archivedActivity' , $section->section_id) }}"
...
@include('partials.modals.faculty.manageArchivedActivity', ['section' => null])
{{-- @include('partials.modals.faculty.viewdetails', ['section' => $section]) --}}
@include('partials.modals.faculty.viewdetailsArchive')
